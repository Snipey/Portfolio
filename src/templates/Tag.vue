    ...
    <main>
      <header>
        <div class="max-w-xl md:max-w-3xl xl:max-w-4xl flex flex-col-reverse mx-auto text-center px-6 pt-24 pb-10 md:py-32 border-b border-gray-300">
          <p class="text-white leading-normal">{{ $page.tag.belongsTo.totalCount }} posts in total</p>
        ...
        <nav class="absolute top-0 left-0 z-20 mt-6 ml-6">
          <g-link to="/" class="text-sm border text-white border-gray-400 opacity-75 hover:opacity-100 rounded-full px-4 py-2 transition-opacity">&larr; Home</g-link>
        </nav>
      </header>
      <section>
